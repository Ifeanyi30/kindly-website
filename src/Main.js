      ...
      >
        <div className="cover-cover mx-auto mt-auto" ref={ref}>
          ...
          <div className={"buttonWrapper mt-3 mx-auto " + colors["margin"]}>
            ...
            />
            <label className={"btn btn-outline-light btn-kindly"} for="danger-outlined">
              APPLY KINDLY
            </label>
          </div>
        </div>
            ...
            <Accordion className="pb-3">
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  ...
                  standards that ensure that individuals' privacy rights are honored and
                  their data appropriately protected. However, if someone wishes to
